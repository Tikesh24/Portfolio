...
let EditPanelComponent = class EditPanelComponent {
    constructor(dataSetter) {
        ...
        this.skillFormGroup = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            skillControl: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormArray"]([]),
            skillValueControl: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormArray"]([])
        });
...
let DataGetterService = class DataGetterService {
    ...
    getPageData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const result = yield this.http.get('/server-api/getPageData').toPromise();
            return result;
        });
    }
    getFeedBackData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const result = yield this.http.get('/server-api/getFeedBackData').toPromise();
            return result;
        });
    }
    updateUserData(data) {
