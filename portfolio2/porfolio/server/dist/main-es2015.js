...
let EditPanelComponent = class EditPanelComponent {
    constructor(dataSetter) {
    ...
    setSkillData() {
        ...
        this.skills.forEach((o, i) => {
            const control = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](i);
            control.setValue(o['key']);
            this.skillFormGroup.controls.skillControl.push(control);
            const controlValue = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](i);
            controlValue.setValue(o['value']);
            this.skillFormGroup.controls.skillValueControl.push(controlValue);
        });
    }
    ...
    addSkill(index) {
        console.log(index);
        const control = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](index + 1);
        ...
        const controlValue = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](index + 1);
    ...
    setExperienceData() {
        ...
        this.experience.forEach((o, i) => {
            const place = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](i);
            place.setValue(o['work-place']);
            this.experienceFormGroup.controls.workPlace.push(place);
            const type = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](i);
            type.setValue(o['work-type']);
            this.experienceFormGroup.controls.workType.push(type);
            const duration = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](i);
            duration.setValue(o['work-duration']);
            this.experienceFormGroup.controls.workDuration.push(duration);
            const descrp = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](i);
    ...
    addExperience(index) {
        const place = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](index);
        place.setValue("Place");
        this.experienceFormGroup.controls.workPlace.push(place);
        const type = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](index);
        type.setValue("Type");
        this.experienceFormGroup.controls.workType.push(type);
        const duration = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](index);
        duration.setValue("Duration");
        this.experienceFormGroup.controls.workDuration.push(duration);
        const descrp = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](index);
...
EditPanelComponent.ctorParameters = () => [
...
let FeedbackPanelComponent = class FeedbackPanelComponent {
    constructor(dataGetterOBj) {
...
FeedbackPanelComponent.ctorParameters = () => [
    { type: _services_data_getter_service__WEBPACK_IMPORTED_MODULE_2__["DataGetterService"] }
];
...
let BlogCompnentComponent = class BlogCompnentComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let BlogTimelineComponent = class BlogTimelineComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let DataGetterService = class DataGetterService {
    constructor(http) {
        this.http = http;
    ...
    getPageData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const result = yield this.http.get(this.envDetails + '/server-api/getPageData').toPromise();
            return result;
        });
    }
    getFeedBackData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const result = yield this.http.get(this.envDetails + '/server-api/getFeedBackData').toPromise();
            return result;
        });
    }
    updateUserData(data) {
...
DataGetterService.ctorParameters = () => [
